...
const { experimentalFuture =false , experimentalRemotePatterns =[] , experimentalUnoptimized ,  } = {"deviceSizes":[640,750,828,1080,1200,1920,2048,3840],"imageSizes":[16,32,48,64,96,128,256,384],"path":"/_next/image","loader":"default","experimentalFuture":true} || {};
const configEnv = {"deviceSizes":[640,750,828,1080,1200,1920,2048,3840],"imageSizes":[16,32,48,64,96,128,256,384],"path":"/_next/image","loader":"default","experimentalFuture":true};
...
const Link = /*#__PURE__*/ _react.default.forwardRef(function LinkComponent(props, forwardedRef) {
    if (false) {}
    let children;
    const { href: hrefProp , as: asProp , children: childrenProp , prefetch: prefetchProp , passHref , replace , shallow , scroll , locale , onClick , onMouseEnter , legacyBehavior =Boolean(true) !== true  } = props, restProps = _objectWithoutPropertiesLoose(props, [
        "href",
        "as",
        "children",
        "prefetch",
...
class Router {
    ...
    _key = createKey();
    static events = (0, _mitt).default();
    constructor(pathname, query, as, { initialProps , pageLoader , App , wrapApp , Component , err , subscription , isFallback , locale , locales , defaultLocale , domainLocales , isPreview , isRsc  }){
   ...
   */ replace(url, as, options = {}) {
    ...
    async getRouteInfo({ route: requestedRoute , pathname , query , as , resolvedAs , routeProps , locale , hasMiddleware , isPreview , unstable_skipClientCache  }) {
        /**
...
function getMiddlewareData(source, response, options) {
    ...
    if (redirectTarget) {
        if (redirectTarget.startsWith("/")) {
            ...
            const pathname1 = (0, _formatNextPathnameInfo).formatNextPathnameInfo({
                ...(0, _getNextPathnameInfo).getNextPathnameInfo(src1.pathname, {
                    nextConfig,
                    parseData: true
                }),
                defaultLocale: options.router.defaultLocale,
...
/* unused reexport */ __webpack_require__(8461)
